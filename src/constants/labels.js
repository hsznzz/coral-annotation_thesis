export const LABELS = [
  { key: 'LC', text: 'Living Coral (LC)', color: 'bg-emerald-500 hover:bg-emerald-600', shortcut: '1' },
  { key: 'PB', text: 'Partially Bleached (PB)', color: 'bg-amber-400 hover:bg-amber-500 text-slate-900', shortcut: '2' },
  { key: 'DC', text: 'Dead Coral (DC)', color: 'bg-red-500 hover:bg-red-600', shortcut: '3' },
  { key: 'DCA', text: 'Dead Coral with Algae (DCA)', color: 'bg-violet-500 hover:bg-violet-600', shortcut: '4' },
];
